...
export default function Notes({ progress, onOpenWrongBook, onOpenSavedBook, onReview, onPracticeSaved }) {
  ...
  return (
    <div className="screen notes-screen">
      ...
      <div className="note-card note-card-wrong" onClick={onOpenWrongBook} role="button" tabIndex={0}>
      ...
      <div className="note-card note-card-saved" onClick={onOpenSavedBook} role="button" tabIndex={0}>
        <div className="note-card-head">
          <span className="note-card-title">
